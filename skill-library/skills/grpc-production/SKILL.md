...
gRPC/protobuf services: schema design, compatibility, deadlines, streaming, retries, status/errors, metadata/auth, load balancing, code generation, and observability.
...
- gRPC and Protocol Buffers official docs
