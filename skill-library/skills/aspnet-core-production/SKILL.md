---
name: aspnet-core-production
description: ASP.NET Core systems: middleware, dependency injection, configuration, authentication/authorization, minimal APIs/controllers, EF Core, testing, hosting, and observability.
---
