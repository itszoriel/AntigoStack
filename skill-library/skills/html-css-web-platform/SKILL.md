---
name: html-css-web-platform
description: "HTML, CSS, SVG, responsive layout, semantics, browser compatibility, forms, modern CSS, and the standards-based web platform."
---
...
- MDN HTML/CSS/SVG and WHATWG/W3C standards
