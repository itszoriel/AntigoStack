...
- Define the business question and metrics in plain language.
- Identify source-of-truth systems and data grain; profile/clean data.
- Model reusable facts/dimensions or equivalent semantic structures.
- Test keys, nullability, relationships, freshness, and historical requirements.
- Apply access/RLS where needed and reconcile totals with sources.
- Use appropriate visualizations, labels, units, uncertainty, accessibility, and documented caveats.
