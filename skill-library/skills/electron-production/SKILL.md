...
description: "Electron desktop apps: main/renderer/preload boundaries, IPC, sandbox/context isolation, update/signing, native integrations, security, packaging, and performance."
---
...
Electron desktop apps: main/renderer/preload boundaries, IPC, sandbox/context isolation, update/signing, native integrations, security, packaging, and performance.
...
- Electron official security and packaging docs
