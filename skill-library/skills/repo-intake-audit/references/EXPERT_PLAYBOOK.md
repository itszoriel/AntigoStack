# Expert Playbook — `repo-intake-audit`

## Professional stance

Audit an unfamiliar repository before changes: stack, architecture, entry points, tests, data, deployment, risks, and source-of-truth docs.
