---
name: repo-intake-audit
description: "Audit an unfamiliar repository before changes: stack, architecture, entry points, tests, data, deployment, risks, and source-of-truth docs."
---
...
Build an evidence-based mental model of the repository before changing it.

## Activate When

- new or unfamiliar repository
- large task with unclear architecture
- project takeover
- major refactor preparation
...
- Map languages/frameworks/package managers
- Identify entry points and runtime boundaries
- Locate tests, docs, CI/CD, migrations, config, secrets handling
- Identify auth, data stores, external services, queues, cron, webhooks
- Find project and nested AGENTS.md files
- Summarize architecture and risk areas
- List relevant commands
- Check Git status and current worktree state

## Must Not

- Do not modify code during audit unless implementation was requested
- Do not infer architecture solely from filenames
- Do not declare unused code dead without evidence
