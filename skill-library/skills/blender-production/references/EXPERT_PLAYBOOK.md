# Expert Playbook — `blender-production`
...
- Confirm target engine/render/export requirements.
- Check units, scale, orientation, origins, transforms, topology, normals, and UVs.
- Review materials/textures, PBR conventions, naming, collections, and modifiers.
- Review rigs, weights, deformation, animation ranges, loops, and root motion as applicable.
- Remove unneeded export clutter and preserve editable source.
- Test export/re-import and engine handoff against asset budgets.
