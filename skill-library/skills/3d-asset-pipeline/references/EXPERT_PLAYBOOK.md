# Expert Playbook — `3d-asset-pipeline`
...
- Define target platform, budgets, editable source formats, and versioning.
- Standardize units, axis, naming, pivots, folders, topology, LODs, UV/texel rules.
- Define texture formats/resolutions/channels, compression, PBR material conventions, and collision.
- Define rig/animation export conventions and runtime format.
- Validate engine import and track asset provenance/license.
- Measure memory, draw calls, and runtime performance on target hardware.
