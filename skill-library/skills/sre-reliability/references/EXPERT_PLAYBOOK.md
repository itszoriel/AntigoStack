# Expert Playbook — `sre-reliability`
...
- Identify critical user-facing journeys and measurable SLIs.
- Define realistic SLOs with product/business input and error-budget policy.
- Identify dependencies that can violate objectives.
- Model failure, graceful degradation, redundancy, recovery, capacity, and saturation.
- Design burn-rate/actionable alerting and review deployment risk.
- Use incidents/postmortems to revise objectives and identify toil automation.
