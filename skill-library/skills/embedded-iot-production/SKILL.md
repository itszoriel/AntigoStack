---
name: embedded-iot-production
description: "Embedded and IoT systems: microcontrollers, firmware, interrupts/timers, memory, power, sensors, UART/I2C/SPI, MQTT, OTA updates, device identity, hardware security, and fleet observability."
---

# embedded-iot-production

**Category:** Specialist Technology

## Purpose

Embedded and IoT systems: microcontrollers, firmware, interrupts/timers, memory, power, sensors, UART/I2C/SPI, MQTT, OTA updates, device identity, hardware security, and fleet observability.
...
- Arduino/MCU vendor docs, OASIS MQTT, embedded platform docs
