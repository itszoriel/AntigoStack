---
name: wordpress-cms-production
description: WordPress sites/plugins/themes: PHP hooks, blocks, REST API, capabilities, escaping/sanitization, updates, caching, plugins, content migration, and hardening.
---
...
WordPress sites/plugins/themes: PHP hooks, blocks, REST API, capabilities, escaping/sanitization, updates, caching, plugins, content migration, and hardening.
