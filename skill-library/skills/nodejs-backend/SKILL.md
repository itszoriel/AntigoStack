---
name: nodejs-backend
description: Node.js server and worker applications including event loop behavior, streams, async errors, modules, TypeScript, HTTP, workers, package/runtime security, and production shutdown.
---
...
Node.js server and worker applications including event loop behavior, streams, async errors, modules, TypeScript, HTTP, workers, package/runtime security, and production shutdown.
