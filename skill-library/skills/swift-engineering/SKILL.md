...
Swift code, optionals, value/reference semantics, concurrency, actors, packages, testing, Apple platform integration, and memory behavior.
...
- Swift.org and Apple Developer docs
