# Expert Playbook — `visual-design-canva`
...
- Establish audience, channel, message, dimensions, and CTA.
- Use provided brand assets and create clear visual hierarchy.
- Check readability, contrast, type size, and color dependence.
- Inventory image/font/video/template provenance and licensing.
- Reject fabricated testimonials, metrics, awards, partners, or certifications.
- Check safe areas, export resolution, compression, dates, URLs, prices, and claims.
...
- Do not assume downloadable means licensed.
- Do not fabricate marketing proof or business facts.
