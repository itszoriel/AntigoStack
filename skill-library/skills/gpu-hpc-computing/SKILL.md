---
name: gpu-hpc-computing
description: "GPU/HPC and parallel computing: CUDA-like programming, kernels, memory transfer, occupancy, numerical correctness, CPU/GPU profiling, parallel algorithms, build toolchains, and reproducibility."
---
...
- NVIDIA CUDA and platform compiler/profiler docs
