...
description: "Game performance profiling across CPU/GPU/frame time, memory, loading, streaming, physics, rendering, scripting/GC, network, thermals, and target-hardware budgets."
---
...
Game performance profiling across CPU/GPU/frame time, memory, loading, streaming, physics, rendering, scripting/GC, network, thermals, and target-hardware budgets.
...
- engine profiler docs and platform tools
