...
description: Ruby on Rails systems: MVC, Active Record, migrations, validations, jobs, caching, security, testing, assets, and deployment.
---
...
Ruby on Rails systems: MVC, Active Record, migrations, validations, jobs, caching, security, testing, assets, and deployment.
