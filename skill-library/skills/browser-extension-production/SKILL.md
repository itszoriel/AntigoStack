---
name: browser-extension-production
description: "Browser extensions: manifests, permissions, content scripts, background/service workers, messaging, storage, CSP, cross-browser differences, privacy, and store review."
---
...
Browser extensions: manifests, permissions, content scripts, background/service workers, messaging, storage, CSP, cross-browser differences, privacy, and store review.
