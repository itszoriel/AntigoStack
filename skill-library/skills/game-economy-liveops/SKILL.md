...
Game economy and live operations: currencies, progression, rewards, sinks/sources, offers, seasons, remote config, events, telemetry, experiments, fraud, rollback, and player fairness.
...
- platform/store/backend docs and project economy rules
