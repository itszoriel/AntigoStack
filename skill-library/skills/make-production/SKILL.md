...
description: "Design, review, and harden Make.com scenarios for production reliability, credentials, scheduling, operations, error handling, rate limits, and cost."
---
...
Apply Make-specific production practices on top of general automation reliability.

## Activate When

- Make.com scenario
- Make automation
- integration scenario hardening
...
- Design modules and routers clearly
- Validate webhook/input data
- Use error handlers
- Use retries selectively
- Respect operation/rate limits
- Prevent duplicates
- Persist state where needed
- Use scheduling/timezones deliberately
- Separate environments where practical
- Document connections/credentials
- Track operations/cost
- Design manual recovery

## Must Not

- Do not hide critical business logic in undocumented formulas
- Do not build infinite retry loops
- Do not duplicate actions on replay
