---
name: android-kotlin-production
description: "Native Android engineering with Kotlin, Jetpack/Compose, architecture, coroutines, lifecycle, storage, networking, permissions, accessibility, performance, and release behavior."
---

# android-kotlin-production

**Category:** Mobile / Desktop

## Purpose

Native Android engineering with Kotlin, Jetpack/Compose, architecture, coroutines, lifecycle, storage, networking, permissions, accessibility, performance, and release behavior.
...
- Android Developers and Kotlin docs
