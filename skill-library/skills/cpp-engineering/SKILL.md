...
description: Modern C++ projects, RAII, ownership, templates, concurrency, build systems, sanitizers, ABI, performance, and undefined-behavior risk.
---
...
Modern C++ projects, RAII, ownership, templates, concurrency, build systems, sanitizers, ABI, performance, and undefined-behavior risk.
...
- ISO C++ resources and C++ Core Guidelines
