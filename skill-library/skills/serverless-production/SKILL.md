...
description: "Serverless functions/workers and event-driven managed compute: cold starts, concurrency, timeouts, retries, idempotency, limits, state, networking, secrets, observability, and cost."
---
...
Serverless functions/workers and event-driven managed compute: cold starts, concurrency, timeouts, retries, idempotency, limits, state, networking, secrets, observability, and cost.
...
- AWS Lambda/Azure Functions/Cloud Run/Functions docs
