# Expert Playbook — `requirements-to-spec`

## Professional stance

Turn a vague or large request into implementation-ready requirements, edge cases, nonfunctional needs, acceptance criteria, and open decisions.
