...
description: Turn a vague or large request into implementation-ready requirements, edge cases, nonfunctional needs, acceptance criteria, and open decisions.
---
...
Convert vague intent into a testable implementation contract.

## Activate When

- feature request lacks acceptance criteria
- multi-step feature
- cross-system change
...
- Identify user goal and actors
- Define in-scope/out-of-scope
- List functional requirements
- List non-functional requirements
- Define acceptance criteria
- Identify edge cases and failure states
- Identify data/security/privacy impacts
- Call out unresolved decisions
