...
description: Portable and database-specific SQL for queries, joins, aggregation, window functions, transactions, CTEs, schema work, and performance-aware analysis.
---
...
- SQL standard concepts plus target database official docs
