# Expert Playbook — `technical-art-shaders`
...
- Establish target hardware, render pipeline, frame budget, and visual target.
- Profile before optimizing and identify expensive shaders/material variants/draw calls.
- Review texture memory/sampling, transparency/overdraw, branching, instancing/batching.
- Review realtime lighting/shadows and VFX/particle budgets.
- Define quality tiers/fallbacks while preserving visual intent.
- Validate changes on target devices using profiler/frame debugger evidence.
