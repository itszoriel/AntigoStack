# Expert Playbook — `privacy-compliance-review`

## Professional stance

Review personal data, cookies, tracking, consent, retention, deletion, third parties, AI processing, and privacy-disclosure mismatches.
...
- Identify known jurisdictions/audiences and build a field-level data inventory.
- Identify sensitive categories and apply data minimization to every field.
- Inventory cookies, SDKs, pixels, analytics, embeds, and tracking.
- Review consent timing, rejection/withdrawal/preferences, processors, retention, deletion/export, backups, and logs.
- Compare actual behavior with privacy disclosures.
- Review AI/automation for hidden provider transfer/retention and flag legal questions.
...
- Coordinate with `web-analytics-tagging` when the problem materially crosses that boundary; do not duplicate its full scope.
