...
description: "Modern PHP applications, Composer, typing, namespaces, errors, sessions, CLI/web SAPIs, security-sensitive language features, and runtime configuration."
---
...
Modern PHP applications, Composer, typing, namespaces, errors, sessions, CLI/web SAPIs, security-sensitive language features, and runtime configuration.
...
- PHP Manual and Composer documentation
