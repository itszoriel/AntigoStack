# Expert Playbook — `realtime-systems`
...
- Choose protocol based on communication/reliability needs.
- Define connection authentication and subscription/action authorization.
- Define message schemas/versioning, ordering, duplicate behavior, heartbeat, and timeouts.
- Design reconnect with backoff/jitter and resync after missed events.
- Bound client buffers/fan-out and handle slow consumers/backpressure.
- Define presence expiry, measure capacity/throughput, and instrument errors/latency/backlog.
