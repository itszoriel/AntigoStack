---
name: vue-nuxt-production
description: "Vue and Nuxt applications: Composition API, reactivity, routing, SSR/hydration, data fetching, state, modules, accessibility, and deployment."
---
...
Vue and Nuxt applications: Composition API, reactivity, routing, SSR/hydration, data fetching, state, modules, accessibility, and deployment.
