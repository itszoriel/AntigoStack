# Expert Playbook — `software-supply-chain`
...
- Map source to dependency resolution, build, test, package, registry, and deploy.
- Identify who/what can modify each stage.
- Review CI tokens, runners, untrusted PR/fork execution, and third-party actions.
- Review lockfiles, dependency provenance, and licenses.
- Generate/validate SBOMs and provenance where justified.
- Protect signing/release credentials and verify published artifact identity.
