...
description: "Review database schema, constraints, normalization, indexing, transactions, tenancy, query patterns, integrity, and operational safety."
---
...
Ensure data design is correct, maintainable, performant, and safe.

## Activate When

- schema design
- slow queries
- new feature with persistence
- multitenancy
- database audit
...
- Check unique/check/not-null constraints
- Assess normalization/denormalization
- Review tenancy boundaries/RLS
- Review indexes against real query patterns
- Review transactions/concurrency
- Check cascade behavior
- Review soft-delete/retention
- Review ORM usage and N+1 risks
- Review data types/timezones

## Must Not

- Do not add indexes blindly
- Do not denormalize without measured need
- Do not rely on application checks when DB constraints are appropriate
