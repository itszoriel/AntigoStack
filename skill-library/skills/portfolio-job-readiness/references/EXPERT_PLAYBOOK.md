# Expert Playbook — `portfolio-job-readiness`
...
- Identify target role and required competencies.
- Map real project evidence to those competencies.
- Remove or qualify unsupported claims.
- Improve README/setup/demo/documentation.
- Highlight technical decisions, trade-offs, testing, security, deployment, and measurable outcomes only when real.
- Prepare concise explanations of architecture, challenges, failures, and lessons.
- Ensure public repos contain no secrets/private data.
- Check links, builds, demos, and screenshots.
