...
Game release engineering for PC/mobile/console storefronts: builds, signing, SDK requirements, achievements/cloud saves, entitlements, age/privacy content, crash reporting, patching, and certification/review.
...
- target platform official release docs
