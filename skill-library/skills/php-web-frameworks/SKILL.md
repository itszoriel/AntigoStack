...
description: "PHP web frameworks such as Laravel and Symfony: routing, DI/service containers, ORM, validation, auth, queues, jobs, caching, testing, and deployment."
---
...
PHP web frameworks such as Laravel and Symfony: routing, DI/service containers, ORM, validation, auth, queues, jobs, caching, testing, and deployment.
...
- Laravel and Symfony official docs
