---
name: webassembly-production
description: "WebAssembly modules and integrations: compilation targets, JS/browser interoperability, memory, WASI where applicable, performance, packaging, security boundaries, and deployment."
---
...
WebAssembly modules and integrations: compilation targets, JS/browser interoperability, memory, WASI where applicable, performance, packaging, security boundaries, and deployment.
...
- MDN WebAssembly and WebAssembly/WASI official docs
