...
description: "Profile application, backend, database, memory, CPU, latency, throughput, and scaling bottlenecks before optimizing."
---
...
Find real bottlenecks across layers.
...
- Inspect DB queries
- Inspect network/external dependencies
- Check caching
- Check concurrency/locks
- Check frontend where relevant
- Prioritize by impact
- Re-measure after changes

## Must Not

- Do not optimize speculative hotspots
- Do not trade correctness/security for speed without explicit decision
