---
name: code-review
description: Review changed or generated code for correctness, regressions, security, maintainability, compatibility, unnecessary complexity, and test gaps.
---
...
Catch defects and risks before merge.

## Activate When

- review request
- pull request
- large change completed
- pre-merge audit
...
- Check readability and duplication
- Classify severity

## Must Not

- Do not nitpick style already enforced by tooling
- Do not request abstractions without clear benefit
- Do not rewrite author's approach unless necessary
