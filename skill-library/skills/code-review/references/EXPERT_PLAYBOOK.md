# Expert Playbook — `code-review`

## Professional stance

Review changed or generated code for correctness, regressions, security, maintainability, compatibility, unnecessary complexity, and test gaps.
