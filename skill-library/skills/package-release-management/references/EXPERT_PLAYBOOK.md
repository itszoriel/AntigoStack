# Expert Playbook — `package-release-management`
...
- Identify public API and compatibility promises.
- Choose versioning policy.
- Review breaking changes and migration notes.
- Run tests/build/package verification.
- Verify package metadata, license, README, repository, and supported runtimes.
- Review dependency ranges and lockfile policy.
- Generate provenance/SBOM/signatures where appropriate.
- Publish from trusted CI where possible.
- Verify the published artifact can be installed and used.
- Document deprecation and rollback/yank strategy.
