# Expert Playbook — `product-ux-discovery`
...
- Identify target users, user outcomes, business outcomes, and constraints.
- Separate real evidence from assumptions; never fabricate interviews or analytics.
- Map happy path, error states, abandonment, permissions, empty states, and recovery.
- Identify accessibility, privacy, localization, trust, mobile, and offline constraints.
- Define functional/non-functional requirements and measurable acceptance criteria.
- List unresolved decisions before implementation.
