# Expert Playbook — `spring-java-production`

## Professional stance

Spring/Spring Boot systems: dependency injection, configuration, web/data/security, transactions, observability, testing, packaging, and JVM operations.
