---
name: robotics-ros2-production
description: ROS 2 robotics systems: nodes, topics/services/actions, QoS, TF, launch, parameters, bags, simulation, navigation/control integrations, real-time constraints, safety, and deployment.
---

# robotics-ros2-production

**Category:** Specialist Technology

## Purpose

ROS 2 robotics systems: nodes, topics/services/actions, QoS, TF, launch, parameters, bags, simulation, navigation/control integrations, real-time constraints, safety, and deployment.
