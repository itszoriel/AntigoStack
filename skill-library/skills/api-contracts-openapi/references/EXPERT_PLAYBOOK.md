# Expert Playbook — `api-contracts-openapi`
...
- Define resources/use cases before endpoints.
- Define request/response schemas, validation, authn/authz expectations, errors, pagination/filter/sort.
- Define idempotency and concurrency/version behavior for mutations.
- Document limits/examples and review backward compatibility.
- Validate the OpenAPI document mechanically.
- Compare implementation behavior with the contract.
