# Expert Playbook — `data-engineering`
...
- Inventory sources, destinations, owners, SLAs, and sensitivity.
- Define source contracts and schema evolution.
- Choose batch, microbatch, streaming, or CDC based on requirements.
- Make ingestion replayable/idempotent and preserve lineage/ingestion metadata.
- Define late, duplicate, missing, corrupt, and out-of-order behavior.
- Design safe backfills, retention, quality monitoring, and environment separation.
