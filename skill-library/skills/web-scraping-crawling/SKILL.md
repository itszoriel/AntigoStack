...
description: Authorized web crawling and scraping for public data with robots/site terms awareness, rate limits, identification, parsing resilience, pagination, deduplication, provenance, and data handling.
---
...
Authorized web crawling and scraping for public data with robots/site terms awareness, rate limits, identification, parsing resilience, pagination, deduplication, provenance, and data handling.
...
- robots.txt RFC, target-site terms/API docs, Playwright/Scrapy-style official docs
