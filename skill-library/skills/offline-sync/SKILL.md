---
name: offline-sync
description: "Design and review offline-first storage, synchronization, conflict resolution, retries, and eventual consistency."
---
...
Make applications usable and correct across disconnects and reconnects.

## Activate When

- offline-first
- sync
- local cache with writes
- mobile offline
- PWA offline
