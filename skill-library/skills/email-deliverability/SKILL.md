...
description: "Application email and transactional email delivery: SPF, DKIM, DMARC, domains, reputation, bounces, complaints, suppression, unsubscribe, templates, queues, and observability."
---
...
- Google/Yahoo sender guidance, RFCs, provider docs
