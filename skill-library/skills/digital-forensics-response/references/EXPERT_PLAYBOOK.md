# Expert Playbook — `digital-forensics-response`

## Professional stance

Defensive digital-forensics workflow for preserving evidence, timelines, logs, endpoint/cloud artifacts, chain of custody, analysis boundaries, and incident handoff.
