# Expert Playbook — `ai-agent-engineering`
...
- Decide whether an agent is required and define goal/stop/unsupported actions.
- Minimize tool set and permissions; give tools precise schemas/errors.
- Separate planning from trusted execution and add approval for consequential actions.
- Bound loops, retries, spend, actions, time, and persisted state.
- Design recovery after partial execution and trace tool/action sequences.
- Build task-success, regression, and safety evals; pair with agent-security.
