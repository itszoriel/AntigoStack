---
name: linux-sysadmin
description: "Linux administration: users/permissions, systemd/services, processes, storage/filesystems, logs, networking, packages, SSH, firewalls, performance, backup, and troubleshooting."
---
...
Linux administration: users/permissions, systemd/services, processes, storage/filesystems, logs, networking, packages, SSH, firewalls, performance, backup, and troubleshooting.
...
- distribution and systemd/Linux official docs
