---
name: game-security-anticheat
description: "Review game security and anti-cheat around client authority, save files, currency, inventory, progression, purchases, leaderboards, networking, and abuse detection."
---
...
Reduce practical cheating while preserving offline and legitimate play requirements.
...
- Classify what must be server-authoritative
- Sign/validate important server-issued state
- Validate purchases server-side where applicable
- Harden save integrity without pretending it is unbreakable
- Detect impossible progression
- Protect leaderboard submissions
- Rate limit economy actions
- Review replay/tampering
- Design audit signals and sanctions carefully
- Preserve offline requirements explicitly
