---
name: dotnet-maui-production
description: .NET MAUI cross-platform apps: lifecycle, XAML/UI, dependency injection, platform services, storage/networking, accessibility, performance, and signing/release.
---

# dotnet-maui-production

**Category:** Mobile / Desktop

## Purpose

.NET MAUI cross-platform apps: lifecycle, XAML/UI, dependency injection, platform services, storage/networking, accessibility, performance, and signing/release.
