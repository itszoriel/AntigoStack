---
name: shell-powershell-engineering
description: Bash/sh and PowerShell scripting for safe automation, quoting, pipelines, error handling, idempotency, remote operations, and cross-platform differences.
---

# shell-powershell-engineering

**Category:** Programming Languages

## Purpose

Bash/sh and PowerShell scripting for safe automation, quoting, pipelines, error handling, idempotency, remote operations, and cross-platform differences.
