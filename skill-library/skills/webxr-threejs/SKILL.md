---
name: webxr-threejs
description: "Browser-based 3D/XR with WebXR and Three.js-like rendering: scenes, cameras, assets, input, performance, WebGL/WebGPU constraints, accessibility alternatives, and device compatibility."
---
...
Browser-based 3D/XR with WebXR and Three.js-like rendering: scenes, cameras, assets, input, performance, WebGL/WebGPU constraints, accessibility alternatives, and device compatibility.
...
- MDN WebXR, Three.js docs, WebGL/WebGPU docs
