---
name: gcp-production
description: Google Cloud architecture and operations across IAM, VPC, compute, storage, databases, serverless, GKE, observability, backup, security, cost, and Architecture Framework.
---
...
Google Cloud architecture and operations across IAM, VPC, compute, storage, databases, serverless, GKE, observability, backup, security, cost, and Architecture Framework.
...
- Google Cloud official docs and Architecture Framework
