...
description: Use Git and GitHub safely for branching, commits, pull requests, code review, merge strategy, releases, tags, protected branches, CODEOWNERS, issues, and repository governance.
---
