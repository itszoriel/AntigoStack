# Expert Playbook — `observability`

## Professional stance

Design logs, metrics, traces, dashboards, alerts, audit events, correlation, sampling, retention, and telemetry privacy.
...
- Start from critical user journeys and reliability objectives/SLIs.
- Add structured logs/correlation while avoiding secrets/unnecessary PII.
- Instrument service/dependency latency/errors and distributed traces where useful.
- Separate operational logs from security/audit events.
- Create question-driven dashboards and actionable SLO-risk alerts.
- Define retention/sampling/cardinality/cost limits and test representative diagnosis.
