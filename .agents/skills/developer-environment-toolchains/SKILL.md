...
description: Review developer workstations, SDKs, compilers, interpreters, package managers, IDE/editor settings, linters, formatters, local services, containers, and reproducible setup.
---
