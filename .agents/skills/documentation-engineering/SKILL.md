...
description: Create, review, and maintain technical documentation that accurately matches implementation, including READMEs, architecture docs, runbooks, API docs, onboarding, troubleshooting, and ADRs.
---
