# Expert Playbook — `documentation-engineering`

## Professional stance

Create or repair accurate technical docs, READMEs, API docs, architecture notes, runbooks, onboarding, ADRs, and troubleshooting.
...
- Inspect implementation before documenting behavior.
- Separate concept, how-to, reference, and troubleshooting material.
- Use runnable commands and validated examples.
- Record prerequisites, versions, assumptions, failures, and recovery.
- Keep contracts synchronized and remove stale/duplicate instructions.
...
- Coordinate with `api-contracts-openapi` when the problem materially crosses that boundary; do not duplicate its full scope.
