# Expert Playbook — `bug-investigation`

## Professional stance

Investigate bugs, crashes, regressions, and failing tests by reproducing, gathering evidence, finding root cause, fixing, and verifying.
