---
name: react-nextjs-production
description: React and Next.js applications: components, hooks, server/client boundaries, routing, data fetching, rendering modes, caching, forms, accessibility, and deployment.
---
...
React and Next.js applications: components, hooks, server/client boundaries, routing, data fetching, rendering modes, caching, forms, accessibility, and deployment.
