...
description: C# and .NET projects including async/await, nullable reference types, dependency injection, configuration, runtime deployment, testing, and diagnostics.
---
...
C# and .NET projects including async/await, nullable reference types, dependency injection, configuration, runtime deployment, testing, and diagnostics.
